...
using AuthorizationCenter.ViewModels.Account;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var user = _applicationDbContext.Users.Where(a => a.Email == model.Email || a.UserName == model.Email).FirstOrDefault();
                    if (user != null)
                    {
                        if (user.IsDeleted)
                        {
                ...
                else
                {
                    ...
                    ModelState.AddModelError("loginResult", "用户名或密码无效!");
                    return View(model);
                }
            }
