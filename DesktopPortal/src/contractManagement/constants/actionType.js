...
//合同审核详情处理
export const OPEN_CONTRACT_DETAIL = 'OPEN_CONTRACT_DETAIL';//打开审核详细
export const CLOSE_CONTRACT_DETAIL = 'CLOSE_CONTRACT_DETAIL';//关闭审核详细
export const GET_CONTRACT_DETAIL = 'GET_CONTRACT_DETAIL';//加载客户详情
export const GET_CONTRACT_DETAIL_COMPLETE = 'GET_CONTRACT_DETAIL_COMPLETE';//加载客户详情完成
