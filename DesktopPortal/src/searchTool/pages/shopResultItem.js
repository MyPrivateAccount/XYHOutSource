                ...
                <Row>
                    ...
                    <Col span={17}>
                        <Row style={{ marginBottom: '10px', cursor: 'pointer' }}>
                            <Col span={20} onClick={(e) => this.handleShopClick(shopInfo.id)}><b className="buildingTitle">{shopInfo.buildingNo}-{shopInfo.floorNo}-{shopInfo.number}</b>（所属楼盘：{activeBuilding.basicInfo.name}）</Col>
                        </Row>
