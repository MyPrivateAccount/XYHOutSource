...
class LeaseInfo extends Component {
    ...
    render() {
        ...
        let startDate = moment(leaseInfo.startDate).format('YYYY-MM-DD')
        let endDate = moment(leaseInfo.endDate).format('YYYY-MM-DD')
        return (
...
function mapStateToProps(state) {
    return {
        leaseInfo: state.search.activeShop.leaseInfo,
    }
}
