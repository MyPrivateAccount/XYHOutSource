    ...
    render() {
        ...
        return (
            <Form layout="horizontal" onSubmit={this.handleSubmit} style={{paddingTop: '5px'}}>
                ...
                {judgePermissions.includes('SOCIAL_SECURITY_VIEW') || this.props.ismodify != 1 ? <SocialSecurity /> : null}
                {judgePermissions.includes('SALARY_VIEW') || this.props.ismodify != 1 ? <Salary /> : null}
                ...
                <Row>
                    <Col style={{textAlign: 'center'}}>
                        <Button type="primary" htmlType="submit" style={{marginRight: '20px'}} disabled={this.hasErrors(getFieldsValue())} >提交</Button>
