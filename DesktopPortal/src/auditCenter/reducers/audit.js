...
reducerMap[actionTypes.GET_UPDATE_RECORD_DETAIL_COMPLETE] = function (state, action) {
    // let activeAuditInfo = action.payload || state.activeAuditInfo;
    // let activeAuditHistory = {...state.activeAuditHistory, updateRecord: activeAuditInfo};
    // if (activeAuditHistory.submitDefineId) {
    //     activeAuditInfo.submitDefineId = activeAuditHistory.submitDefineId;
    // }
    // return Object.assign({}, state, {activeAuditInfo: activeAuditInfo, activeAuditHistory: activeAuditHistory});
    let curActiveInfo = action.payload || {};
    return Object.assign({}, state, {curActiveInfo: curActiveInfo});
}
...
//商铺详情获取完成
reducerMap[actionTypes.GET_SHOP_DETAIL_END] = function (state, action) {
    return Object.assign({}, state, {shopOfActiveInfo: action.payload || {}});
}
