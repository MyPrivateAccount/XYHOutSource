...
class ZYWAuditDealInfo extends Component {
    state = {
        review: null,
        content: null,
        record: null,
    ...
    componentWillReceiveProps(newProps) {
        ...
        // let submitDefineId = activeAuditInfo.submitDefineId;
...
export default connect(mapStateToProps, mapDispatchToProps)(ZYWAuditDealInfo);