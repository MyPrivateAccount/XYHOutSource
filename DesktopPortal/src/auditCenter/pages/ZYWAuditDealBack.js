...
import {getZywCustomerDealInfo, setLoadingVisible} from '../actions/actionCreator';
...
class ZYWAuditDealBack extends Component {
    state = {
        review: null,
        content: null,
        record: null,
    ...
    componentWillReceiveProps(newProps) {
        ...
        //         this.props.dispatch(getZYWCustomerDealInfo(activeAuditHistory.submitDefineId));
        //     }
    ...
    componentDidMount = () => {
        ...
        if (submitDefineId) {
            this.props.dispatch(setLoadingVisible(true));
            this.props.dispatch(getZywCustomerDealInfo(submitDefineId));
        }
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ZYWAuditDealBack);