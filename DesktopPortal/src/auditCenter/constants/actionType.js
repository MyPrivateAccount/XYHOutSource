...
export const GET_SHOP_DETAIL_END='GET_SHOP_DETAIL_END';
//成交信息
export const GET_CUSTOMER_DEALINFO = 'GET_CUSTOMER_DEALINFO';//获取成交信息
export const GET_CUSTOMER_DEALINFO_COMPLETE = 'GET_CUSTOMER_DEALINFO_COMPLETE';//获取成交信息

//租壹屋
export const GET_ZYW_BUILDING_DETAIL = 'GET_ZYW_BUILDING_DETAIL';//租壹屋楼盘详细
export const GET_ZYW_SHOP_DETAIL='GET_ZYW_SHOP_DETAIL';//租壹屋商铺详情
export const GET_ZYW_CUSTOMER_DEALINFO = 'GET_ZYW_CUSTOMER_DEALINFO';//获取租壹屋成交信息
export const GET_ZYW_UPDATE_RECORD_DETAIL = 'GET_ZYW_UPDATE_RECORD_DETAIL';//获取租壹屋动态详细


//合同
export const GET_CONTRACT_DETAIL = 'GET_CONTRACT_DETAIL';//获取合同分类信息
