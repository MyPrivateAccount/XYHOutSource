...
const menuDefine = [
    ...
    {menuID: "menu_limit", displayName: "额度设置", menuIcon: 'appstore-o', /*requirePermission:['COMPANYA_MANAGE']*/},
    {menuID: "menu_ctrl", displayName: "费用管控表", menuIcon: 'contacts'},
    {menuID: "menu_total", displayName: "费用统计表", menuIcon: 'appstore-o', /*requirePermission:['COMPANYA_MANAGE']*/},
];
const homeStyle = {
    navigator: {
        cursor: 'pointer'
