export const ACTION_ROUTE = "ZYWCustomerIndex";
...
export const GET_REAPEAT_GROUP = 'GET_REAPEAT_GROUP'//获取重客重复分组
export const GET_REAPEAT_GROUP_COMPLETE = 'GET_REAPEAT_GROUP_COMPLETE'//获取重客重复分组
export const GET_CUSTOMER_BY_GROUP = 'GET_CUSTOMER_BY_GROUP';//根据重客分组获取客户信息
export const GET_CUSTOMER_BY_GROUP_COMPLETE = 'GET_CUSTOMER_BY_GROUP_COMPLETE';//根据重客分组获取客户信息
export const GET_REPEAT_COUNT = 'GET_REPEAT_COUNT';//获取重复数量
export const GET_REPEAT_COUNT_COMPLETE = 'GET_REPEAT_COUNT_COMPLETE';//
//调客审核列表
...
// 拉无效
export const SHOW_CUSTOMER_LOSS_MODAL = 'SHOW_CUSTOMER_LOSS_MODAL';
export const HIDE_CUSTOMER_LOSS_MODAL = 'HIDE_CUSTOMER_LOSS_MODAL';
export const CUSTOMER_LOSS = 'CUSTOMER_LOSS';
export const CUSTOMER_LOSS_START = 'CUSTOMER_LOSS_START';
export const CUSTOMER_LOSS_END = 'CUSTOMER_LOSS_END';
// 激活
export const CUSTOMER_LOSS_ACTIVE = 'CUSTOMER_LOSS_ACTIVE';
export const CUSTOMER_LOSS_ACTIVE_START = 'CUSTOMER_LOSS_ACTIVE_START';
export const CUSTOMER_LOSS_ACTIVE_END = 'CUSTOMER_LOSS_ACTIVE_END';


// 意向业态
export const GET_TREE_LIST = 'GET_TREE_LIST';
export const GET_TREE_LIST_COMPLETE = 'GET_TREE_LIST_COMPLETE';
