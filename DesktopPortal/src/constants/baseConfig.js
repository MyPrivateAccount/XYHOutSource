...
//export const basicDataServiceUrl = window._basicDataUrl || "https://testapi.xinyaohangdc.com";//"http://localhost:7000"//  http://192.168.50.240:7000";认证地址
 export const basicDataServiceUrl = window._basicDataUrl || 'http://localhost:7000';// 云上
