...
export const basicDataServiceUrl = window._basicDataUrl || "http://localhost:7000"//"http://localhost:7000";//"https://testapi.xinyaohangdc.com";//  http://192.168.50.240:7000";认证地址
