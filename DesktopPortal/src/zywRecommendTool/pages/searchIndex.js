...
import {getMyRecommendBuilding, searchBuilding, setLoading, getBuildingDetail, getBuildingShops} from '../actions/actionCreator';
...
class SearchIndex extends Component {
    ...
    componentDidMount() {
        this.handleSearch();
        this.props.dispatch(globalAction(getDicParList(["TRADE_MIXPLANNING", "ZYW_SALE_MODE", "PROJECT_SALE_STATUS", "SHOP_CATEGORY", "ZYW_RENT_RANGE", "ZYW_SHOP_SALE_STATUS"])));
    }
            ...
            <div style={{width: '80%', margin: '0 auto', height: '100%'}} className='recommendTool'>
                {!showDetailPage ? <div>
                    <Row className='searchBox'>
                        <Col span={24}>
                            <Input addonBefore="租壹屋" prefix={<Icon type="search" />} onChange={this.handleSearchKeyChange} onPressEnter={(e) => this.handleSearch()} style={{width: '400px'}} placeholder='请输入房源名称' />
