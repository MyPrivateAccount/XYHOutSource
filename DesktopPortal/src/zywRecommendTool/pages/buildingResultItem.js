...
class BuildingResultItem extends Component {
    ...
    render() {
        ...
        const hasRegionRecommendPermission = this.props.judgePermissions.includes("ZYW_RECOMMEND_REGION");
        const hasFilialeRecommendPermission = this.props.judgePermissions.includes("ZYW_RECOMMEND_FILIALE");
                    ...
                    <Col span={19}>
                        <div className='itemLeft'>
                            <div className='imgDiv'>
                                <img style={{width: '11rem', height: '9rem'}} src={buildInfo.icon || '../../../images/default-icon.jpg'} />
                            </div>
                            ...
                            <Col>
                                <p>
                                    <label style={{color: 'red', fontSize: '1.3rem', fontWeight: 'bold'}}>
                                        {buildInfo.minPrice || buildInfo.maxPrice ? (buildInfo.minPrice + "-" + buildInfo.maxPrice + '元/㎡/月') : '暂未定价'}</label>
                                </p>
                            </Col>
                        </Row>
                    </Col>
