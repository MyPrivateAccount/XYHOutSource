...
import BuildingDishEdit from '../../zywBusinessComponents/building/buildingDetail'
    ...
    render() {
        ...
        return (
            ...
            <Card title={<Breadcrumb separator=">">
                ...
                {/**楼盘列表详情**/}
                {
                    showResult.showBuildingDetal ? <div style={{height: '100%', overflowY: 'auto', padding: '24px 32px'}}><BuildingDishEdit buildingInfo={buildingInfo} buildingShops={activeBuildingShops} basicData={(rootBasicData || {}).dicList} getShopDetail={this.getShopDetail} /></div> : null
                }
                {/**商铺列表详情**/}
                {
