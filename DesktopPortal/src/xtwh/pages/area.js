...
import { getAreaListAsync, setCurrentArea, delAreaAsync ,
        addArea, editArea, viewArea} from '../actions'
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getDistrictList: (parent) => dispatch(getAreaListAsync({ level: 2, parent: parent })),
        getTradingAreaList: (parent) => dispatch(getAreaListAsync({ level: 3, parent: parent })),
        setCurrentCity: (code) => dispatch(setCurrentArea({ level: 1, code: code })),
        setCurrentDistrict: (code) => dispatch(setCurrentArea({ level: 2, code: code })),
        setCurrentTradingArea: (code) => dispatch(setCurrentArea({ level: 3, code: code })),
        delCity: (code)=> dispatch(delAreaAsync({level:1, code: code})),
        delDistrict: (code)=> dispatch(delAreaAsync({level:2, code: code})),
        delTradingArea: (code)=> dispatch(delAreaAsync({level:3, code: code})),
        addCity: ()=>dispatch(addArea({level:1, parent:''})),
        addDistrict: (parent) => dispatch(addArea({level:2,parent:parent})),
        addTradingArea: (parent) => dispatch(addArea({level:3, parent:parent})),
        editCity: (code)=> dispatch(editArea({level:1, code: code})),
        editDistrict: (code)=> dispatch(editArea({level:2, code: code})),
        editTradingArea: (code)=> dispatch(editArea({level:3, code: code})),
    }
}
