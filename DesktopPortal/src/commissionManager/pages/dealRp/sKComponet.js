            ...
            <Layout>
                <Layout.Content>
                    ...
                    <Row style={{margin:5}}>
                        ...
                        <Col span={12}>
                          <label>
                              <span style={{ marginRight: '10px' }}>进账日期</span>
                              <DatePicker style={{width:120}}></DatePicker>
                          </label>
                        </Col>
                    </Row>
                    <Row style={{margin:5}}>
                        ...
                        <Col span={8} style={{marginLeft:124}}>
                          <label>
                              <span style={{ marginRight: '10px' }}>交款方</span>
                              <Input style={{width:80}}></Input>
                          </label>
                        </Col>
                    </Row>
                    <Row style={{margin:5}}>
                        ...
                        <Col span={8} style={{marginLeft:113}}>
                          <label>
                              <span style={{ marginRight: '10px' }}>公司账户</span>
                              <Select style={{width:80}}></Select>
                          </label>
                        </Col>
                    </Row>
                    <Row style={{margin:5}}>
                        <Col span={24}>
                          <label>
                              <span style={{ marginRight: '10px' }}>收款方式</span>
                              <Select style={{width:80}}></Select>
                          </label>
                        </Col>
                    </Row>
