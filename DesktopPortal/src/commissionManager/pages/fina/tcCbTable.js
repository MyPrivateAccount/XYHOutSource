...
class TCCbTable extends Component{
    appTableColumns = [
        ...
        { title: '直接成本', dataIndex: 'cost', key: 'cost' },
        { title: '分摊入成本', dataIndex: 'ftCost', key: 'ftCost' },
        { title: '成本', dataIndex: 'totalCost', key: 'totalCost' },
        {
    ...
    render(){
        return (
            <Layout>
                ...
                <Row style={{margin:10}}>
                    <Col span={24}>
                    <SearchCondition handleSearch={this.handleSearch} orgPermission={'YJ_CW_TCCBB'}/>
                    </Col>
                </Row>
                <Row style={{margin:10}}>
                    <Col span={24}>
