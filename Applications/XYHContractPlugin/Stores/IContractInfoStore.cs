...
namespace XYHContractPlugin.Stores
{
    public interface IContractInfoStore
    {
        ...
        Task<ContractInfo> CreateAsync(SimpleUser userinfo, ContractInfo buildingBaseInfo, string modifyid, string ext1, string ext2, string checkaction, CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task CreateModifyAsync(SimpleUser userinfo, string contractid, string modifyid, int ntype, string checkaction, ExamineStatusEnum exa = ExamineStatusEnum.UnSubmit, bool updatetocontract = true, string ext1 = null, string ext2 = null, string ext3 = null, string ext4 = null, string ext5 = null, CancellationToken cancellationToken = default(CancellationToken));
