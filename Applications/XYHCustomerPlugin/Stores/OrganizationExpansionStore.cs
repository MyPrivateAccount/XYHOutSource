...
namespace XYHCustomerPlugin.Stores
{
    ...
    {
        private ILogger Logger = LoggerManager.GetLogger("CustomerOrganizationExpansionStore");
        //Db
        ...
        public OrganizationExpansionStore(CustomerDbContext customerDbContext)
        {
